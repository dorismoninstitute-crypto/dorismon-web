...
export default function Home() {
  ...
  const jsonLd = {
    ...
    description: "Instituto de inglés en Santo Domingo. Clases online y presenciales para niños, jóvenes y adultos, con profesores certificados y certificación CEFR.",

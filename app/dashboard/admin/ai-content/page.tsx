...
import { Sparkles, AlertTriangle, Copy, Check, RefreshCw, FileQuestion, BookOpen, ClipboardList } from "lucide-react";
      ...
      {resultado && (
        <Card>
          <CardBody>
            ...
            <div className="bg-amber-50 border border-amber-100 rounded-lg p-3 mb-5 text-xs text-amber-800">
